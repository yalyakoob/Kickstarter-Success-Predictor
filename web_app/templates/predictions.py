...
def predict(category, campaign_duration,
    ...
    if y_pred == 1:
        ...
        #return "You Are {}% Likely to Fail.".format(round(y_pred_prob[0], 2))


# def predict(goal_usd, campaign_duration_in_days, category_art=None, category_music=None,
#             category_crafts=None, category_comics=None, category_food=None, category_publishing=None,
#             category_technology=None, category_journalism=None, category_design=None, category_film_video=None,
#             category_theatre=None, category_games=None, category_photography=None, category_fashion=None,
#             country_GB=None,
#             country_US=None, country_CA=None, country_other=None):
#     df = pd.DataFrame(d={'goal_usd': goal_usd, 'campaign_duration_in_days': campaign_duration_in_days,
#                          'category_art': category_art, 'category_music': category_music,
#                          'category_crafts': category_crafts, 'category_comics': category_comics,
#                          'category_food': category_food, 'category_publishing': category_publishing,
#                          'category_technology': category_technology, 'category_journalism': category_journalism,
#                          'category_design': category_design, 'category_film_video': category_film_video,
#                          'category_theatre': category_theatre, 'category_games': category_games,
#                          'category_photography': category_photography, 'category_fashion': category_fashion,
#                          'country_GB': country_GB, 'country_US': country_US, 'country_CA': country_CA,
